...
import {PropertyDetailService} from './propertydetail.services';
...
displayPropDetail:boolean;
  constructor(private service:PropertyDetailService,private route: ActivatedRoute) { }

  ngOnInit() {

    this.propertyId=localStorage.getItem("propertyId");

    this.service.getPropertyDetail().subscribe(data =>{
